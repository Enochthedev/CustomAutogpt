...
{
    public class ClaudeModel : IAgentModel
    {
        private readonly HttpClient _httpClient;
        private readonly string _apiKey;

        public ClaudeModel(HttpClient httpClient, string apiKey)
        {
        ...
        public async Task<string> GenerateResponse(string prompt)
        {
            ...
            var response = await _httpClient.PostAsync("https://api.anthropic.com/v1/claude/completions", jsonContent);
